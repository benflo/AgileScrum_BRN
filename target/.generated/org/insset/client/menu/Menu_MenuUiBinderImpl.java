// .ui.xml template last modified: 1507734212000
...
public class Menu_MenuUiBinderImpl implements UiBinder<com.google.gwt.user.client.ui.HTMLPanel, org.insset.client.menu.Menu>, org.insset.client.menu.Menu.MenuUiBinder {
  ...
  class Widgets {
    ...
    /**
     * Getter for remise called 1 times. Type: DEFAULT. Build precedence: 3.
     */
    private com.google.gwt.user.client.ui.MenuItem get_remise() {
      return build_remise();
    }
    private com.google.gwt.user.client.ui.MenuItem build_remise() {
      // Creation section.
      final com.google.gwt.user.client.ui.MenuItem remise = new com.google.gwt.user.client.ui.MenuItem("", (com.google.gwt.user.client.Command) null);
      // Setup section.
      remise.setHTML(template_html3().asString());

      this.owner.remise = remise;
